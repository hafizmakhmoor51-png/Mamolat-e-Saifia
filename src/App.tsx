  ...
  return (
    <div dir="rtl" className="flex flex-col items-center min-h-screen pb-12 overflow-x-hidden">
      ...
      <main className="w-[95%] max-w-[600px] flex flex-col gap-5">
            ...
            <div className="p-5 border-t border-dashed border-[#D4AF37]/40 bg-black/50">
              <ul className="space-y-3">
                {[
                  ...
                  { name: "نفس", color: "text-[#8d6e63]", desc: "خاک نما (مٹیالا)، پیشانی (بالوں کی جڑیں)۔" },
                  { name: "قالب", color: "text-[#D4AF37]", desc: "آتش نما (آگ جیسا)، وسطِ دماغ۔" },
                ].map((l, i) => (
        ...
        <section>
          <h2 className="text-3xl font-bold text-[#D4AF37] text-center border-b-2 border-dashed border-[#D4AF37] pb-3 mb-4">اسباقِ طریقت</h2>
          {[
            {
              title: "طریقہ عالیہ چشتیہ",
              note: "کتاب معمولاتِ سیفیہ کے مطابق:",
              items: [
                { label: "پہلا سبق (کلمہ ھُو)", desc: "\"ھُو\" کو آپ روح سے شروع کریں، روح سے قلب اور قلب سے سرّ، سرّ سے اخفیٰ، اخفیٰ سے خفی اور پھر روح تک ایک گول دائرہ کی شکل میں گھماتے جائیں اور اس کو ایک تلوار فرض کر کے قلب کے باطن سے نکالیں۔" },
                { label: "دوسرا سبق (اللّٰه ھُو)", desc: "\"اللّٰه\" کا تصور قلب پر اور \"ھُو\" کا تصور روح پر کریں اور زبان سے بھی ادا کریں۔ (تعداد 1000)" },
                { label: "تیسرا سبق (ھُو اللّٰه)", desc: "\"ھُو\" کا تصور روح پر اور \"اللّٰه\" کا تصور قلب پر رکھ کر ذکر کریں۔ (تعداد 1000)" },
                { 
                  label: "چوتھا سبق", 
                  desc: "اَنْتَ الْهَادِي اَنْتَ الْحَقُّ لَيْسَ الْهَادِي إِلَّا هُوَ",
                  subDesc: "\"اَنْتَ الْھَادِی اَنْتَ\" کا تصور قلب پر، \"الْحَقُّ\" کا تصور اخفیٰ پر، \"لَیْسَ الْھَادِی\" کو اخفیٰ سے واپس شروع کر کے \"اِلَّا\" کو قلب پر اور \"ھُو\" کو روح پر ادا کریں۔ (تعداد 1000)"
                },
                { 
                  label: "مراقبہ چشتیہ", 
                  desc: "5 منٹ یا 4 رکعت نماز کی مقدار سانس بند کر کے قلب میں اللہ اللہ کہنا ہے۔",
                  niyyat: "فیض می آید از ذاتِ بے چوں بلطیفہ قلب من، بواسطہ پیرانِ کبار، خصوصاً حضرت خواجہ معین الدین حسن چشتی اجمیریؒ"
                }
              ]
            },
            {
              title: "طریقہ عالیہ قادریہ",
              note: "روزانہ 313 مرتبہ استغفار (اَسْتَغْفِرُ اللّٰهَ الَّذِي لَا اِلٰهَ اِلَّا هُوَ الْحَيُّ الْقَيُّوْمُ وَاَتُوْبُ اِلَيْهِ) پڑھنا ہے۔",
              items: [
                { label: "پہلا سبق (نفی اثبات)", desc: "پہلے \"لا اِلٰهَ اِلَّا اللّٰه\" کہیں، پھر 100 مرتبہ \"لا اِلٰهَ اِلَّا اللّٰه\" کی تکرار کریں اور آخر میں \"مُحَمَّدٌ رَّسُوْلُ اللّٰه ﷺ\" پڑھیں۔" },
                { label: "دوسرا سبق (الا اللّٰه)", desc: "پہلے \"لا اِلٰهَ اِلَّا اللّٰه\" کہیں، پھر 100 مرتبہ \"اِلَّا اللّٰه\" کی تکرار کریں اور آخر میں \"مُحَمَّدٌ رَّسُوْلُ اللّٰه ﷺ\" پڑھیں۔" },
                { label: "تیسرا سبق (اللّٰه جل جلالہ)", desc: "پہلے \"اللّٰه جل جلالہ\" کہیں، پھر 100 مرتبہ \"اللّٰه اللّٰه\" کی تکرار کریں اور آخر میں \"جل جلالہ\" کہیں۔" },
                { label: "چوتھا سبق (ھُو جل جلالہ)", desc: "پہلے \"ھُو جل جلالہ\" کہیں، پھر 100 مرتبہ \"ھُو ھُو\" کی تکرار کریں اور آخر میں \"جل جلالہ\" کہیں۔" },
                { 
                  label: "پانچواں سبق (مراقبہ قادریہ)", 
                  desc: "5 منٹ سانس بند کر کے دل میں اللہ اللہ۔",
                  niyyat: "فیض می آید از ذاتِ بے چوں بلطیفہ قلب من، بواسطہ پیرانِ کبار، خصوصاً محبوب سبحانی سید شیخ عبدالقادر جیلانیؒ"
                },
                {
                  label: "درود شریف",
                  desc: "اللّٰهُمَّ صَلِّ عَلٰی مُحَمَّدٍ وَّآلِهِ وَعِتْرَتِهِ بِعَدَدِ كُلِّ مَعْلُومٍ لَّكَ",
                  subDesc: "تعداد 313 مرتبہ"
                }
              ]
            },
            {
              ...
              items: [
                ...
                { label: "چوتھا سبق (ھُو جل جلالہ)", desc: "پہلے \"ھُو جل جلالہ\" کہیں، پھر 100 مرتبہ \"ھُو ھُو\" کی تکرار کریں اور آخر میں \"جل جلالہ\" کہیں۔" },
                { 
                  label: "پانچواں سبق (مراقبہ سہروردیہ)", 
                  desc: "کم از کم 20 منٹ اور بغیر حبسِ نفس (سانس روکے بغیر) کیا جاتا ہے۔",
                  niyyat: "فیض می آید از ذاتِ بے چوں بلطیفہ قلب من، بواسطہ پیرانِ کبار، خصوصاً حضرت شیخ شہاب الدین سہروردیؒ"
                }
              ]
            }
          ].map((s, i) => (
            <details key={i} className="bg-black/60 border border-[#D4AF37] rounded-xl overflow-hidden mb-3 shadow-lg group">
              ...
              <div className="p-5 border-t border-dashed border-[#D4AF37]/40 bg-black/50">
                {s.note && (
                  <p className="mb-4 text-[#ffdd57] font-bold border-b border-[#D4AF37]/20 pb-2">{s.note}</p>
                )}
                <ul className="space-y-4">
                  {s.items.map((item, idx) => (
                    <li key={idx} className="border-r-2 border-[#ffdd57] pr-4">
                      ...
                      {item.desc && (
                        <span className={`text-gray-200 block mb-1 ${item.label.includes('سبق') && !item.subDesc ? 'italic' : ''}`}>
                          {item.desc}
                        </span>
                      )}
                      {item.subDesc && (
                        <span className="text-gray-400 text-sm block italic mb-1">{item.subDesc}</span>
                      )}
                      {item.niyyat && (
                        <div className="mt-2 bg-white/5 p-3 rounded border border-[#D4AF37]/20">
                          <span className="text-[#D4AF37] text-sm font-bold block mb-1">نیت:</span>
                          <span className="text-gray-300 italic text-sm leading-relaxed block">"{item.niyyat}"</span>
                        </div>
                      )}
                    </li>
                  ))}
